...
namespace BibliotecaAPITests.Utilidades
{
    public class BasePruebas
    {
            ...
            bool ignorarSeguridad = true)
        {
            ...
            factory = factory.WithWebHostBuilder(builder =>
            {
                builder.ConfigureTestServices(services =>
                {
                    ...
                    d => d.ServiceType == typeof(IDbContextOptionsConfiguration<AplicationDBContext>))!;
            ...
            WebApplicationFactory<Program> factory)
        {
            ...
            var respuestaAutenticacion = JsonSerializer.Deserialize<RespuestaAutentificacionDTO>(contenido,
